...
class WorkNowController {
 ...
 Stream<QuerySnapshot > getMyPostSelectedCategoryWork(category){
   ...
   final dos= db.collection('Post Work Info').where("uid",isEqualTo: FirebaseAuth.instance.currentUser!.uid);
   ...
   final dos= db.collection('Post Work Info').where("uid",isNotEqualTo: FirebaseAuth.instance.currentUser!.uid);
    return dos.where('Category',isEqualTo:category ).snapshots();
  }
}
