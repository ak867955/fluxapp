...
class cfile extends StatelessWidget {
cfile({super.key});

  // Replace with your actual audio data (name and image path)
  final List<AudioItem> audioData = [
    AudioItem(name: "File 1", imagePath: "asset/pexels-toa-heftiba-şinca-1194420.jpg"),
    AudioItem(name: "File 2", imagePath: "asset/pexels-toa-heftiba-şinca-1194420.jpg"),
    AudioItem(name: "File 3", imagePath: "asset/pexels-toa-heftiba-şinca-1194420.jpg"),
  ]; 
