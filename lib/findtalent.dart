...
class ftalent extends StatefulWidget {
  String selectedCategory;
  ftalent({super.key,required this.selectedCategory});

  @override
  State<ftalent> createState() => _fworkState();
}

class _fworkState extends State<ftalent> {
          ...
          Expanded(
            ...
            child: StreamBuilder<QuerySnapshot>(
                stream: WorkNowController()
                    .getAllPostExceptMinSelectedCategoryWork(widget.selectedCategory),
