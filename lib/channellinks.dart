...
clink({super.key});
  ...
  final List<AudioItem> audioData = [
    AudioItem(name: "Link 1", imagePath: "asset/pexels-toa-heftiba-şinca-1194420.jpg"),
    AudioItem(name: "Link 2", imagePath: "asset/pexels-toa-heftiba-şinca-1194420.jpg"),
    AudioItem(name: "Link 3", imagePath: "asset/pexels-toa-heftiba-şinca-1194420.jpg"),
  ];
